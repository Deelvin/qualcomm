...
class GraphModuleDebug(graph_runtime.GraphModule):
    ...
    def run(self, number=10, run_delay=0, **input_dict, ):
        ...
        self._run_debug(number, run_delay)
    ...
    def run_individual(self, number, run_delay=0, repeat=1, min_repeat_ms=0):
        ret = self._run_individual(number, run_delay, repeat, min_repeat_ms)
