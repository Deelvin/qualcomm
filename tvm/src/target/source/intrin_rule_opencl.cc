...
TVM_REGISTER_GLOBAL("tvm.intrin.rule.opencl.mad").set_body(DispatchPureExtern<OpenCLMad24>);

TVM_REGISTER_GLOBAL("tvm.intrin.rule.opencl.mul24").set_body(DispatchPureExtern<Direct>);
